...
适用于 [AstrBot](https://github.com/Soulter/AstrBot) 的武夷学院教务系统自动查课表插件，注意，本插件目前尚不能返回验证码图片，因此，当您填写错误密码且尝试登录3次及以上时，需要自行打开浏览器成功登录一次来消除验证码验证模块。
